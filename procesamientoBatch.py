...
# Guardar los datos procesados en un archivo CSV en descarga y sobrescribir si el archivo ya existe
df_cleaned.write.mode('overwrite').format('csv').option('header', 'true').save('file:///home/vboxuser/Documentos/cleaned_data.csv')